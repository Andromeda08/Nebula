...
namespace Nebula::nvk
{
    ...
    void Device::select_device(const vk::Instance& instance)
    {
        ...
        {
            throw nlog::make_exception("Failed to find a suitable {}", nlog::red("vk::PhysicalDevice"));
        }
        ...
        #ifdef NVK_VERBOSE
        std::cout << nlog::fmt_info("Selected {} : {}", nlog::red("vk::PhysicalDevice"), m_physical_device_properties.deviceName.data()) << std::endl;
        #endif
    }
    ...
    void Device::create_device()
    {
        ...
        if (const vk::Result result = m_physical_device.createDevice(&create_info, nullptr, &m_device);
            result != vk::Result::eSuccess)
        {
            throw nlog::make_exception("Failed to create {} ({})", nlog::red("vk::Device"), nlog::red(to_string(result)));
        }

        #ifdef NVK_VERBOSE
        std::cout << nlog::fmt_info("Created {}", nlog::red("vk::Device")) << std::endl;
        #endif
